...
def fire_confetti():
    """Fire confetti effect using JavaScript"""
    components.html("""
...
# ==================== MAIN HTML CONTENT ====================
def main_html_content():
    """Main HTML content embedded in Streamlit"""
    
    # Get base64 encoded images
    img1_base64 = get_base64_of_file(gallery[0]['path'])
    img2_base64 = get_base64_of_file(gallery[1]['path'])
    img3_base64 = get_base64_of_file(gallery[2]['path'])
    ...
    try:
        with open("img/piringan.png", "rb") as f:
            img_bytes = f.read()
            vinyl_base64 = base64.b64encode(img_bytes).decode()
    except FileNotFoundError:
        st.error("Vinyl image not found")
    ...
    <head>
        ...
        <title>Graduation Sinta Istamarina</title>
        <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Montserrat:wght@300;500;700&family=Dancing+Script:wght@700&family=Marcellus&display=swap" rel="stylesheet">
        <style>
            body {{
    ...
    <body>
        <div class="container">
            ...
            <!-- Gallery -->
            <h2 class="gallery-title" style="text-align: center; font-family: 'Dancing Script', cursive; color: #d23669; font-size: 3.5rem; margin: 60px 0 30px;">Memory Lane 🌸</h2>
            
            <div class="gallery">
                <div class="gallery-item">
                    <img src="data:image/jpeg;base64,{img1_base64}" alt="{gallery[0]['caption']}">
                    <div class="image-caption">{gallery[0]['caption']}</div>
                </div>
                <div class="gallery-item">
                    <img src="data:image/jpeg;base64,{img2_base64}" alt="{gallery[1]['caption']}">
                    <div class="image-caption">{gallery[1]['caption']}</div>
                </div>
                <div class="gallery-item">
                    <img src="data:image/jpeg;base64,{img3_base64}" alt="{gallery[2]['caption']}">
                    <div class="image-caption">{gallery[2]['caption']}</div>
                </div>
            </div>
            
            <!-- Music Player -->
            <div class="music-player">
                <h2 style="font-family: 'Dancing Script', cursive; color: #d23669; font-size: 3rem; margin-bottom: 30px;">Celebration Anthem</h2>
                ...
                <div style="display: flex; justify-content: center; margin: 30px 0; position: relative;">
                    <div style="width: 200px; height: 200px; position: relative;">
                        <img id="cassette" src="data:image/png;base64,{vinyl_base64}" style="
                            width: 100%;
                            height: 100%;
                            object-fit: contain;
            ...
            <!-- Celebration Button -->
            <button id="celebrateBtn" class="btn-celebrate">👑 Click for Royal Celebration!</button>
            ...
            ">
                <div style="
                    ...
                    background: linear-gradient(90deg, transparent, #ffd700, transparent);
                "></div>
                Made with 💖 for Princess {data['name']}'s {data['graduation_year']} Graduation<br>-by Mon
            </div>
        </div>
